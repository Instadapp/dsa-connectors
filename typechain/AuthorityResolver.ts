...
export interface AuthorityResolverInterface extends utils.Interface {
  functions: {
...
export interface AuthorityResolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuthorityResolverInterface;
