...
export interface ConnectV2UniswapV3Interface extends utils.Interface {
  functions: {
...
export interface ConnectV2UniswapV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2UniswapV3Interface;
