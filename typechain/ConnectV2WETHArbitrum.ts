...
export interface ConnectV2WETHArbitrumInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2WETHArbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2WETHArbitrumInterface;
