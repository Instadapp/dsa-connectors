...
export interface ConnectCurveThreePoolInterface extends utils.Interface {
  functions: {
...
export interface ConnectCurveThreePool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectCurveThreePoolInterface;
