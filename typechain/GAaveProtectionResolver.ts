...
export interface GAaveProtectionResolverInterface extends utils.Interface {
  functions: {
...
export interface GAaveProtectionResolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GAaveProtectionResolverInterface;
