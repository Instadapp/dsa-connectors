...
export interface AaveProviderInterfaceInterface extends utils.Interface {
  functions: {
...
export interface AaveProviderInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveProviderInterfaceInterface;
