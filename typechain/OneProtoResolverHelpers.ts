...
export interface OneProtoResolverHelpersInterface extends utils.Interface {
  functions: {};
...
export interface OneProtoResolverHelpers extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneProtoResolverHelpersInterface;
