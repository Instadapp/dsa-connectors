...
export interface LiquidityAccessMultiInterface extends utils.Interface {
  functions: {
...
export interface LiquidityAccessMulti extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityAccessMultiInterface;
