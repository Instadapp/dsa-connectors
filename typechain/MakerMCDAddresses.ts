...
export interface MakerMCDAddressesInterface extends utils.Interface {
  functions: {
...
export interface MakerMCDAddresses extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MakerMCDAddressesInterface;
