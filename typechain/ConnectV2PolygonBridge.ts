...
export interface ConnectV2PolygonBridgeInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2PolygonBridge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2PolygonBridgeInterface;
