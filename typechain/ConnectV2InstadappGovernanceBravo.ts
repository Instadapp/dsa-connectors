...
export interface ConnectV2InstadappGovernanceBravoInterface
...
export interface ConnectV2InstadappGovernanceBravo extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2InstadappGovernanceBravoInterface;
