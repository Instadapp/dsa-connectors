...
export interface GAaveProtectionMainnetConnectorInterface
...
export interface GAaveProtectionMainnetConnector extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GAaveProtectionMainnetConnectorInterface;
