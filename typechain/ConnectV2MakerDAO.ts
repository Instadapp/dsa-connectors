...
export interface ConnectV2MakerDAOInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2MakerDAO extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2MakerDAOInterface;
