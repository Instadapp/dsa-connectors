...
export interface ConnectV2ReflexerInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2Reflexer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2ReflexerInterface;
