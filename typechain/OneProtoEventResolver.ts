...
export interface OneProtoEventResolverInterface extends utils.Interface {
  functions: {};
...
export interface OneProtoEventResolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneProtoEventResolverInterface;
