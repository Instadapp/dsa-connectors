...
export interface ConnectV2AaveV2AvalancheInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2AaveV2Avalanche extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2AaveV2AvalancheInterface;
