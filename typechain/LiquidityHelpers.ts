...
export interface LiquidityHelpersInterface extends utils.Interface {
  functions: {
...
export interface LiquidityHelpers extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityHelpersInterface;
