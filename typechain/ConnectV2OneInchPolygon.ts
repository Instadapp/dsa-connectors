...
export interface ConnectV2OneInchPolygonInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2OneInchPolygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2OneInchPolygonInterface;
