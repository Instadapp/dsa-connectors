...
export interface LiquidityAccessHelperInterface extends utils.Interface {
  functions: {
...
export interface LiquidityAccessHelper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityAccessHelperInterface;
