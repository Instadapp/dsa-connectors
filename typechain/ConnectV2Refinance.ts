...
export interface ConnectV2RefinanceInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2Refinance extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2RefinanceInterface;
