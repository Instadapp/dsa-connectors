...
export interface ConnectV2OneInchInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2OneInch extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2OneInchInterface;
