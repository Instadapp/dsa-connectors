...
export interface ConnectV2AuthArbitrumInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2AuthArbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2AuthArbitrumInterface;
