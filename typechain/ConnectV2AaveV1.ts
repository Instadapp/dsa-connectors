...
export interface ConnectV2AaveV1Interface extends utils.Interface {
  functions: {
...
export interface ConnectV2AaveV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2AaveV1Interface;
