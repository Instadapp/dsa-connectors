...
export interface CompoundHelpersInterface extends utils.Interface {
  functions: {
...
export interface CompoundHelpers extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompoundHelpersInterface;
