...
export interface ConnectV2PoolTogetherInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2PoolTogether extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2PoolTogetherInterface;
