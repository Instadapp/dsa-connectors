...
export interface ConnectV2CompoundInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2Compound extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2CompoundInterface;
