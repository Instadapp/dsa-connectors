...
export interface UniswapV3ResolverInterface extends utils.Interface {
  functions: {
...
export interface UniswapV3Resolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV3ResolverInterface;
