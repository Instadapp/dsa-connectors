...
export interface ConnectV2WAVAXAvalancheInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "LogDeposit(uint256,uint256,uint256)": EventFragment;
    "LogWithdraw(uint256,uint256,uint256)": EventFragment;
  };
...
export interface ConnectV2WAVAXAvalanche extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2WAVAXAvalancheInterface;
  ...
  filters: {
    "LogDeposit(uint256,uint256,uint256)"(
      tokenAmt?: null,
      getId?: null,
      setId?: null
    ...
    "LogWithdraw(uint256,uint256,uint256)"(
      tokenAmt?: null,
      getId?: null,
      setId?: null
