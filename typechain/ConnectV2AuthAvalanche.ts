...
export interface ConnectV2AuthAvalancheInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2AuthAvalanche extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2AuthAvalancheInterface;
