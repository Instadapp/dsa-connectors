...
export interface ConnectV2LiquityInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2Liquity extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2LiquityInterface;
