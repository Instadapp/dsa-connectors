...
export interface ConnectV2UniswapV2Interface extends utils.Interface {
  functions: {
...
export interface ConnectV2UniswapV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2UniswapV2Interface;
