...
export interface OneInchResolverHelpersInterface extends utils.Interface {
  functions: {};
...
export interface OneInchResolverHelpers extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneInchResolverHelpersInterface;
