...
export interface LiquidityResolverInterface extends utils.Interface {
  functions: {
...
export interface LiquidityResolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityResolverInterface;
