...
export interface ConnectV2GelatoInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "LogMultiCancelTasks(tuple[])": EventFragment;
    ...
    "LogSubmitTask(tuple,tuple,uint256)": EventFragment;
    "LogSubmitTaskChain(tuple,tuple[],uint256)": EventFragment;
    "LogSubmitTaskCycle(tuple,tuple[],uint256)": EventFragment;
  };
...
export type LogMultiCancelTasksEvent = TypedEvent<
  [TaskReceiptStructOutput[]],
  { taskReceipt: TaskReceiptStructOutput[] }
>;
...
export type LogSubmitTaskEvent = TypedEvent<
  [ProviderStructOutput, TaskStructOutput, BigNumber],
  {
    provider: ProviderStructOutput;
...
export interface ConnectV2Gelato extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2GelatoInterface;
  ...
  filters: {
    ...
    "LogSubmitTask(tuple,tuple,uint256)"(
    ...
    "LogSubmitTaskChain(tuple,tuple[],uint256)"(
      provider?: ProviderStruct | null,
    ...
    "LogSubmitTaskCycle(tuple,tuple[],uint256)"(
      provider?: ProviderStruct | null,
      tasks?: TaskStruct[] | null,
      expiryDate?: BigNumberish | null
