...
export interface StaticConnectBasicInterface extends utils.Interface {
  functions: {
...
export interface StaticConnectBasic extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StaticConnectBasicInterface;
