...
export interface ConnectV2BMakerDAOInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2BMakerDAO extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2BMakerDAOInterface;
