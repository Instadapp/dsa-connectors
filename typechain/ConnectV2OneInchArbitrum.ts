...
export interface ConnectV2OneInchArbitrumInterface extends utils.Interface {
  functions: {
    "name()": FunctionFragment;
    "sell(address,address,uint256,uint256,bytes,uint256)": FunctionFragment;
  };
...
export interface ConnectV2OneInchArbitrum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2OneInchArbitrumInterface;
