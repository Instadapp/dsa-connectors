...
export interface AaveV2LendingPoolProviderInterfaceInterface
...
export interface AaveV2LendingPoolProviderInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV2LendingPoolProviderInterfaceInterface;
