...
export interface BasicExtraResolverInterface extends utils.Interface {
  functions: {
...
export interface BasicExtraResolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BasicExtraResolverInterface;
