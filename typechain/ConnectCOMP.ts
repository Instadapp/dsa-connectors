...
export interface ConnectCOMPInterface extends utils.Interface {
  functions: {
    "ClaimComp(uint256)": FunctionFragment;
    "ClaimCompThree(address[],address[],uint256)": FunctionFragment;
    "ClaimCompTwo(address[],uint256)": FunctionFragment;
...
export interface ConnectCOMP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectCOMPInterface;
