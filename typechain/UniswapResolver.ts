...
export interface UniswapResolverInterface extends utils.Interface {
  functions: {
...
export interface UniswapResolver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapResolverInterface;
