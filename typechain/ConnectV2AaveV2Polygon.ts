...
export interface ConnectV2AaveV2PolygonInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2AaveV2Polygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2AaveV2PolygonInterface;
