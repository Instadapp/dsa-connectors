...
export interface ConnectV2BCompoundInterface extends utils.Interface {
  functions: {
...
export interface ConnectV2BCompound extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ConnectV2BCompoundInterface;
