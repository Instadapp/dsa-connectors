...
export interface InstaCompoundMappingInterface extends utils.Interface {
  functions: {
...
export interface InstaCompoundMapping extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstaCompoundMappingInterface;
